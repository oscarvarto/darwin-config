...
in {
  ...
  config = mkIf cfg.enable (lib.mkMerge [
    ...
    (lib.mkIf pkgs.stdenv.isLinux {
      xdg.configFile."yazelix/assets/logo.png".source = builtins.path {path = ../assets/logo.png;};
      xdg.configFile."yazelix/assets/icons/48x48/yazelix.png".source = builtins.path {path = ../assets/icons/48x48/yazelix.png;};
      xdg.configFile."yazelix/assets/icons/64x64/yazelix.png".source = builtins.path {path = ../assets/icons/64x64/yazelix.png;};
      xdg.configFile."yazelix/assets/icons/128x128/yazelix.png".source = builtins.path {path = ../assets/icons/128x128/yazelix.png;};
      xdg.configFile."yazelix/assets/icons/256x256/yazelix.png".source = builtins.path {path = ../assets/icons/256x256/yazelix.png;};
      xdg.configFile."yazelix/docs/desktop_icon_setup.md".source = builtins.path {path = ../docs/desktop_icon_setup.md;};
