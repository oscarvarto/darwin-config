...
- **Preserves existing workflow** - you still manage the Yazelix config repo yourself
...
- Does not install packages directly (packages installed via your Nix configuration)
