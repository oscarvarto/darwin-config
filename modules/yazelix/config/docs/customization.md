...
- **Editor Terminal Integration**: Use Yazelix tools in VS Code or Cursor integrated terminals. See [editor_terminal_integration.md](./editor_terminal_integration.md).
