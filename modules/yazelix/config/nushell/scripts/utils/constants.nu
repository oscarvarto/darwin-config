...
export const YAZELIX_SHELL_COMMAND = "bash -l -c 'NUSHELL_THEME=dark nu --login ~/.config/yazelix/nushell/scripts/core/start_yazelix.nu'"
export const YAZELIX_THEME = "Abernathy"
export const GHOSTTY_THEME = "Catppuccin Mocha"
...
export const SHELL_ARGS_BASH = '["bash", "-l", "-c", "nu --login ~/.config/yazelix/nushell/scripts/core/start_yazelix.nu"]'
export const SHELL_ARGS_STRING = '["-l", "-c", "nu --login ~/.config/yazelix/nushell/scripts/core/start_yazelix.nu"]'
