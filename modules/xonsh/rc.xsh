...
# Check if starship is available and configure it
import subprocess
try:
    ...
    print("Warning: Starship not found, using default xonsh prompt")
...
# =============================================================================
# Atuin Integration (History)
# =============================================================================

try:
    # Check if atuin is available and initialize
    atuin_path = $(which atuin).strip()
    if atuin_path:
